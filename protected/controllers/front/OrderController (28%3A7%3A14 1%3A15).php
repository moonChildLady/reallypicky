...
$body .= '  <a href="httpss://www.reallypicky.com/order/'.$orderModel->order_id.'">付款頁面</a>';
$body .= '</div>';
...
$body.='  <div style="border-bottom:1px solid #999; margin-top:8px; padding:6px 10px; font-size:15px;" align="left"><strong>有效日期：'.$create_date->format('Y年m月d日').' – '.$create_date2->format('Y年m月d日').'</strong></div>';
