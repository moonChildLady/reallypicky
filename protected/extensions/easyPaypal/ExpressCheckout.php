...
$nvpstr = "&ADDRESSOVERRIDE=1".$shiptoAddress."&".$this->getProductString()."&ReturnUrl=".$this->returnURL."&CANCELURL=".$this->cancelURL."&CURRENCYCODE=".$this->currencyCode."&NOSHIPPING=1&ALLOWNOTE=0&LOCALECODE=zh_HK"; 
