...
class Order extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('courier_name, courier_website, courier_tracking_no', 'length', 'max'=>50),
	...
	public function attributeLabels()
	{
		return array(
			...
			'shipment_cost' => 'Shipment Cost',
			'sendShipmentEmail'=>'send shipment confirmation email to customer',
	...
	public function search()
	{
		...
		if(!empty($this->order_created_date)){
			$date_form = explode(" - ", $this->order_created_date)[0];
			$date_to = explode(" - ", $this->order_created_date)[1];
			$criteria->condition= "order_created_date between :date_form and :date_to";
			$criteria->params[':date_form']=$date_form;
			$criteria->params[':date_to']=trim($date_to);
		}
		...
		$criteria->compare('courier_website',$this->courier_website,true);
		$criteria->compare('courier_tracking_no',$this->courier_tracking_no,true);
		$criteria->compare('sendShipmentEmail',$this->sendShipmentEmail,true);

		return new CActiveDataProvider($this, array(
			'criteria'=>$criteria,
			'sort'=>array(
				'defaultOrder'=>'order_created_date DESC',
			),
		));
	}
 ...
 function getorderStatus(){
 	//$status_ = array('1'=>'待付款','2'=>'已付款','3'=>'付款未能成功','4'=>'處理中','5'=>'己送出','6'=>'請與客服聯絡','7'=>'其他');
