...
<?php echo $form->errorSummary($model); ?>
	...
	<?php //echo $form->textFieldGroup($model,'comp_id',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','maxlength'=>11)))); ?>
		<?php echo $form->dropDownListGroup($model,'comp_id',array(
		'widgetOptions' => array(
			'data' =>  CHtml::listData(Company::model()->findAll(), 'id', 'comp_name'),
	...
	<?php echo $form->dropDownListGroup($model,'currency1',array(
		'widgetOptions' => array(
			'data' =>  array('HKD'=>'HKD','USD'=>'USD'),
			'htmlOptions' => array('class' => 'span5'),
			)
		)
		);?>
	...
	<?php echo $form->dropDownListGroup($model,'currency2',array(
		'widgetOptions' => array(
			'data' =>  array('HKD'=>'HKD','USD'=>'USD'),
			'htmlOptions' => array('class' => 'span5'),
			)
	...
	<?php echo $form->dropDownListGroup($model,'currency3',array(
		'widgetOptions' => array(
			'data' =>  array('HKD'=>'HKD','USD'=>'USD'),
			'htmlOptions' => array('class' => 'span5'),
			)
